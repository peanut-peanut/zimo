<template>
    <div class="terms-conditions-container">
        <Header isFrom="TermsConditions" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/G2kLwQHUli4Uotk3Ql7jqj02pEe"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/G2kLwQHUli4Uotk3Ql7jqj02pEe";
