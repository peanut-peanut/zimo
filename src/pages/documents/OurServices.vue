<template>
    <div class="our-services-container">
        <Header isFrom="OurServices" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/OEufwFITdikyCnklsr3jml0kpoz"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/OEufwFITdikyCnklsr3jml0kpoz";
