<template>
    <div class="guangdong-container">
        <Header isFrom="GuangDong" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/HYj8wxn1cisE7EklZl8jBBN9pBf"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/HYj8wxn1cisE7EklZl8jBBN9pBf";
