...
export const seoConfig = {
    home: {
        ...
        description:
            "ZIMO is a professional study abroad platform helping international students apply to top Chinese universities. We offer comprehensive services including university applications, visa assistance, accommodation, and more. Start your China study journey with ZIMO today!",
        keywords:
            "zimo, ZIMO, study in china, chinese universities, china study abroad, university application china, chinese scholarship, international students china, study abroad consulting, china education, beijing university, tsinghua university",
        ogImage: "https://zimo.club/assets/image/Logo.png",
    },
    aboutUs: {
        title: "About ZIMO - Professional China Study Abroad Platform",
        description:
            "Learn about ZIMO - Founded in 2020, we help 4000+ students annually with Chinese university applications. Trusted by students worldwide for comprehensive study abroad services.",
        keywords:
            "about ZIMO, china study abroad platform, education consulting, study in china services, university application assistance",
        ogImage: "https://zimo.club/assets/image/AboutUs/Top/ZimoTitle.png",
    },
    program: {
        title: "Study Programs in China - ZIMO University Application",
        description:
            "Explore 30000+ study programs across 400+ Chinese universities. Find your perfect degree program with ZIMO - from undergraduate to doctoral studies in China.",
        keywords:
            "china study programs, chinese university programs, study abroad programs china, undergraduate programs china, graduate programs china, doctoral programs china",
        ogImage: "https://zimo.club/assets/image/Program/NoContentImage.png",
    },
    programDetail: {
        title: "Program Details - Study in China with ZIMO",
        description:
            "Detailed information about study programs in Chinese universities. Learn about tuition fees, duration, application deadlines, and more to make an informed decision.",
        keywords:
            "china university program, study program details, chinese university course, program application, study in china details",
        ogImage: "https://zimo.club/assets/image/Program/NoContentImage.png",
    },
    successfulCases: {
        title: "Success Stories - ZIMO Student Admissions",
        description:
            "Read inspiring success stories from international students who achieved their dreams of studying in China with ZIMO. 95%+ admission rate to top universities.",
        keywords:
            "china study success stories, student admissions china, university acceptance stories, study abroad testimonials, ZIMO success rate",
        ogImage:
            "https://zimo.club/assets/image/SuccessfulCases/AdmissionCaseImage.png",
    },
    guides: {
        title: "Study in China Guide - Complete Resources for International Students",
        description:
            "Complete guide to studying in China. Learn about universities, cities, scholarships, application process, and life in China for international students.",
        keywords:
            "study in china guide, china education guide, chinese universities guide, study abroad china tips, china student life",
        ogImage: "https://zimo.club/assets/image/Logo.png",
    },
    studyInChina: {
        title: "Study in China - Complete Guide for International Students",
        description:
            "Everything you need to know about studying in China. From choosing universities to application process, visa requirements, and student life in China.",
        keywords:
            "study in china, international students china, china education system, chinese universities, study abroad china",
        ogImage: "https://zimo.club/assets/image/Logo.png",
    },
    cities: {
        title: "Best Cities to Study in China - University Cities Guide",
        description:
            "Discover the best cities for international students in China: Beijing, Shanghai, Hangzhou, Shenzhen, and more. Find your ideal study destination.",
        keywords:
            "best cities study china, beijing universities, shanghai universities, chinese cities students, study destinations china",
        ogImage:
            "https://zimo.club/assets/image/Home/PopularCities/ChinaMap.png",
    },
    universities: {
        title: "Chinese Universities Guide - Top Universities in China",
        description:
            "Comprehensive guide to top Chinese universities including Tsinghua, Peking University, Fudan, and more. Find rankings, programs, and admission requirements.",
        keywords:
            "chinese universities, top universities china, tsinghua university, peking university, fudan university, university rankings china",
        ogImage: "https://zimo.club/assets/image/Logo.png",
    },
    scholarships: {
        title: "China Scholarships for International Students - ZIMO Guide",
        description:
            "Find scholarships for studying in China. Government scholarships, university scholarships, and other funding opportunities for international students.",
        keywords:
            "china scholarships, chinese government scholarship, university scholarships china, study abroad funding china, international student scholarships",
        ogImage: "https://zimo.club/assets/image/Logo.png",
    },
    applyNow: {
        title: "Apply Now - Start Your China Study Journey with ZIMO",
        description:
            "Ready to study in China? Start your application with ZIMO today. Our expert team will guide you through the entire process from application to arrival.",
        keywords:
            "apply study china, china university application, study abroad application, ZIMO application, start china study journey",
        ogImage:
            "https://zimo.club/assets/image/ApplyNow/ApplyNowBackground.png",
    },
};
...
export const structuredDataTemplates = {
    organization: {
        ...
        description:
            "Professional study abroad platform helping international students apply to top Chinese universities",
        address: {
            "@type": "PostalAddress",
            addressCountry: "CN",
        },
    ...
    educationalOrganization: {
        ...
        url: "https://zimo.club",
        description:
            "Study abroad consulting platform specializing in Chinese university applications",
        areaServed: "Worldwide",
    ...
    service: {
        ...
        description:
            "Comprehensive study abroad services for students applying to Chinese universities",
        areaServed: "Worldwide",
        serviceType: "Education Consulting",
    },
};
...
function addFAQStructuredData() {
    const commonFAQs = [
        ...
        {
            question:
                "What programs are available for international students in China?",
        ...
        {
            question:
                "What support does ZIMO provide during the application process?",
...
function addHomePageStructuredData() {
    const homeData = {
        ...
        description:
            "Leading platform for international students to apply to Chinese universities",
        url: "https://zimo.club",
        foundingDate: "2020",
        areaServed: "Worldwide",
        serviceType: "Education Consulting",
...
function addProgramDetailStructuredData() {
    ...
    const universityName =
        ...
        "University in China";
    const tuitionFee =
        document.querySelector(".info-row:nth-child(5) .info-value")
            ?.textContent || "";
    ...
    const programDetailData = {
        ...
        educationalCredentialAwarded: programTitle.includes("Bachelor")
            ? "Bachelor's Degree"
            : programTitle.includes("Master")
            ? "Master's Degree"
            : programTitle.includes("PhD")
            ? "Doctoral Degree"
            : "Degree",
    };
...
function addAboutPageStructuredData() {
    const aboutData = {
        ...
        name: "About ZIMO",
        description:
            "Learn about ZIMO's mission to help international students study in China",
...
function addSuccessPageStructuredData() {
    const successData = {
        ...
        name: "Success Stories",
        description:
            "Read inspiring success stories from international students who achieved their dreams of studying in China with ZIMO",
