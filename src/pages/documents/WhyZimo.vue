<template>
    <div class="why-zimo-container">
        <Header isFrom="WhyZimo" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/Jxeqw9wvCiHt1Jk0Xk0j6bHJpJG"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/Jxeqw9wvCiHt1Jk0Xk0j6bHJpJG";
