<template>
    <div class="privacy-policy-container">
        <Header isFrom="PrivacyPolicy" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/TtXqw8ATjiqeSZk3m5WjPmYdpve"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/TtXqw8ATjiqeSZk3m5WjPmYdpve";
