<template>
    <div class="shenzhen-container">
        <Header isFrom="Shenzhen" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/TwyhwrJX0iXKIlkeCXIjGZnNplh"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/TwyhwrJX0iXKIlkeCXIjGZnNplh";
