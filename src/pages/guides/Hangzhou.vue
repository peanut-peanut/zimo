<template>
    <div class="hangzhou-container">
        <Header isFrom="Hangzhou" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/QzCzwVOb3iGksCkQ5sWjfq7zpCe"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/QzCzwVOb3iGksCkQ5sWjfq7zpCe";
