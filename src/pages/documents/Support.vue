<template>
    <div class="support-container">
        <Header isFrom="Support" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/MrYswg41FiQLGDkFwcbjLVm3pKh"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/MrYswg41FiQLGDkFwcbjLVm3pKh";
