<template>
    <div class="shanghai-container">
        <Header isFrom="Shanghai" />

        <div class="content-container">
            <div class="iframe-wrapper">
                <iframe
                    src="https://ajp357puub52.jp.larksuite.com/wiki/PvbOwpu0diY4vykMzkvjLVUepIg"
                    class="feishu-iframe"
                    frameborder="0"
                    allowfullscreen
...
const DOC_URL = "https://ajp357puub52.jp.larksuite.com/wiki/PvbOwpu0diY4vykMzkvjLVUepIg";
